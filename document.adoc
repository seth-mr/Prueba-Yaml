...
| TC-CR-01
| SaveMessageValidMessageAddsMessage
...
| TC-CR-02
| SaveMessageValidMessageCallsSaveChangesOnce
...
| TC-CR-03
| SaveMessageEmptyUsernameThrowsArgumentException
...
| TC-CR-04
| SaveMessageUserNotFoundThrowsInvalidOperationException
...
| TC-CR-05
| GetChatByUsernameEmptySenderThrowsArgumentException
...
| TC-CR-06
| GetChatByUsernameEmptyRecipientThrowsArgumentException
...
| TC-CR-07
| GetChatByUsernameSenderNotFoundThrowsInvalidOperationException
...
| TC-CR-08
| GetChatByUsernameRecipientNotFoundThrowsInvalidOperationException
...
| TC-CR-09
| GetChatByUsernameNoMessagesReturnsEmptyList
...
| TC-CR-10
| GetChatByUsernameReturnsMessagesOrderedAndMappedCorrectly
| sender="sender", recipient="dest"
| BD tiene ambos usuarios. +
...
| TC-CR-11
| GetIdByUsernameNullUsernameThrowsArgumentException
| username = null
| No requiere BD. +
Invocación directa.
...
| TC-CR-12
| GetIdByUsernameUserNotFoundThrowsInvalidOperationException
| username = "ghost"
| usuarios vacíos.
| Se lanza InvalidOperationException.
| Excepción controlada.
...
| TC-CR-13
| GetIdByUsernameExactMatchReturnsUserId
| username = "seth"
...
| TC-CR-14
| GetIdByUsernameCaseInsensitiveMatchReturnsUserId
| username = "playerone"
...
| TC-CR-15
| GetIdByUsernameUserHasMultipleProfilesReturnsMatchingUserId
| username = "seth"
...
| TC-CR-16
| GetIdByUsernameOnlyOneUserMatchesReturnsCorrectId
| username = "seth"
...
| TC-FR-01
| EnsureDifferentUsersSameIdsThrowsUserValidationError
...
| TC-FR-02
| EnsureDifferentUsersDifferentIdsDoesNotThrow
...
| TC-FR-03
| EnsureUsersExistUserMissingThrowsUserNotFound
...
| TC-FR-04
| EnsureUsersExistBothExistDoesNotThrow
| idUsuario1 = 1, idUsuario2 = 2
...
| TC-FR-05
| EnsureNotFriendsAlreadyFriendsThrowsAlreadyFriends
| idUsuario1 = 1, idUsuario2 = 2
...
| TC-FR-06
| EnsureNotFriendsNoFriendshipDoesNotThrow
| idUsuario1 = 1, idUsuario2 = 2
...
| TC-FR-07
| EnsureFriendsNoFriendshipThrowsFriendsLoadError
| idUsuario1 = 1, idUsuario2 = 2
...
| TC-FR-08
| EnsureFriendsFriendshipExistsDoesNotThrow
| idUsuario1 = 1, idUsuario2 = 2
...
| TC-FR-09
| EnsureNotBlockedIsBlockedThrowsFriendsLoadError
...
| TC-FR-10
| EnsureNotBlockedNoBlockDoesNotThrow
| idBloqueador = 1, idBloqueado = 2
...
| TC-FR-11
| EnsureNotBlockedSelfSameUserThrowsUserValidationError
| idUsuario1 = 5, idUsuario2 = 5
...
| TC-FR-12
| EnsureNotBlockedSelfDifferentUsersDoesNotThrow
| idUsuario1 = 1, idUsuario2 = 2
...
| TC-FR-13
|EnsureNoPendingRequestPendingRequestExistsThrowsFriendRequestAlreadyPending
| emisor = 1, receptor = 2
...
| TC-FR-14
| EnsureNoPendingRequestNoPendingRequestDoesNotThrow
| emisor = 1, receptor = 2
...
| TC-FR-15
| EnsurePendingRequestExistsNoPendingThrowsFriendsLoadError
| emisor = 1, receptor = 2
...
| TC-FR-16
| EnsurePendingRequestExistsPendingExistsDoesNotThrow
| emisor = 1, receptor = 2
...
| TC-FR-17
| FriendshipExistsWhenFriendshipExistsReturnsTrue
| idUsuario1 = 1, idUsuario2 = 2
...
| TC-FR-18
| FriendshipExistsWhenFriendshipDoesNotExistReturnsFalse
| idUsuario1 = 1, idUsuario2 = 2
...
| TC-FR-19
| IsBlockedWhenUserIsBlockedReturnsTrue
| idBloqueador = 1, idBloqueado = 2
...
| TC-FR-20
| IsBlockedWhenUserIsNotBlockedReturnsFalse
| idBloqueador = 1, idBloqueado = 2
| La lista bloqueos está vacía. +
Se invoca IsBlocked.
| Se verifica que el resultado es false.
...
| TC-FR-21
| PendingRequestExistsWhenPendingRequestExistsReturnsTrue
| emisor = 1, receptor = 2
...
| TC-FR-22
| PendingRequestExistsWhenNoPendingRequestReturnsFalse
| emisor = 1, receptor = 2
...
| TC-FR-23
| MapToFriendDtoWithValidProfileReturnsCorrectDto
...
| TC-FR-24
| MapToFriendDtoNoProfileThrowsException
...
| TC-FR-25
| GetUserIdsValidDifferentUsersReturnsCorrectTuple
...
| TC-FR-26
| GetUserIdsSameUserThrowsUserValidationError
...
| TC-FR-27
| ApplyBlockAlreadyBlockedThrowsException
...
| TC-FR-28
| ApplyBlockRemovesFriendshipAndPendingRequests
| bloqueadorId = 1, bloqueadoId = 2
...
| TC-FR-30
| RemoveBlockBlockNotFoundThrowsException
| bloqueadorId = 1, bloqueadoId = 2
| La lista bloqueos está vacía. +
...
| TC-FR-31
| RemoveBlockExistingBlockRemovesEntry
| bloqueadorId = 1, bloqueadoId = 2
...
| TC-FR-32
| RemoveBlockNoMatchingBlockThrowsException
| bloqueadorId = 1, bloqueadoId = 2
...
| TC-FR-33
| RemoveBlockMultipleMatchingBlocksRemovesOnlyFirst
| bloqueadorId = 1, bloqueadoId = 2
...
| TC-FR-34
| RemoveFriendshipIfExistsFriendshipFoundRemovesEntry
| idUsuario1 = 1, idUsuario2 = 2
...
| TC-FR-35
| RemoveFriendshipIfExistsFriendshipFoundReversedIdsRemovesEntry
| idUsuario1 = 1, idUsuario2 = 2
...
| TC-FR-36
| RemoveFriendshipIfExistsNoFriendshipNoChanges
| idUsuario1 = 1, idUsuario2 = 2
...
| TC-FR-37
| RemoveFriendshipIfExistsMultipleFriendshipsRemovesOnlyFirstMatch
| idUsuario1 = 1, idUsuario2 = 2
...
| TC-FR-38
| RemoveFriendshipIfExistsEmptyListNoException
| idUsuario1 = 1, idUsuario2 = 2
| La lista amistades está vacía. +
Se invoca RemoveFriendshipIfExists.
| Se verifica que no se lanza ninguna excepción.
...
| TC-FR-39
| RemovePendingRequestsExactMatchRemovesRequest
| emisor = 1, receptor = 2
...
| TC-FR-40
| RemovePendingRequestsReversedMatchRemovesRequest
| emisor = 1, receptor = 2
...
| TC-FR-41
| RemovePendingRequestsNoMatchingRequestsNoChanges
| emisor = 1, receptor = 2
...
| TC-FR-42
| RemovePendingRequestsMultipleMatchesRemovesAllMatches
| emisor = 1, receptor = 2
...
| TC-FR-43
| RemovePendingRequestsEmptyListNoException
| emisor = 1, receptor = 2
| La lista solicitudes_amistad está vacía. +
Se invoca RemovePendingRequests.
...
| TC-FR-44
| RemovePendingRequestsMixedRequestsRemovesOnlyThoseMatchingUsers
| emisor = 1, receptor = 2
...
| TC-FR-45
| GetFriendsNoFriendshipsReturnsEmptyList
| username = "seth"
...
| TC-FR-46
| GetFriendsOneFriendshipWhereUserIsUser1ReturnsFriendDto
| username = "seth" (id=1)
...
| TC-FR-47
| GetFriendsOneFriendshipWhereUserIsUser2ReturnsFriendDto
| username = "seth" (id=1)
...
| TC-FR-48
| GetFriendsMultipleFriendshipsReturnsAllFriends
| username = "seth" (id=1)
...
| TC-FR-49
| GetFriendsFriendWithoutProfileUsesDefaultValues
| username = "seth" (id=1)
...
| TC-FR-50
| GetFriendRequestsNoRequestsReturnsEmptyList
| username = "seth" (id=1)
| solicitudes_amistad está vacía. +
...
| TC-FR-51
| GetFriendRequestsOnePendingRequestReturnsFriendDto
| username = "seth" (id=1)
...
| TC-FR-52
| GetFriendRequestsIgnoresNonPendingRequests
| username = "seth" (id=1)
...
| TC-FR-53
| GetFriendRequestsMultiplePendingRequestsReturnsAll
| username = "seth" (id=1)
...
| TC-FR-54
| GetFriendRequestsEmitterHasNoProfileUsesDefaultValues
| username = "seth" (id=1)
...
| TC-FR-55
| UpdateBlockStatusBlockSelfThrowsUserValidationError
...
| TC-FR-56
| UpdateBlockStatusBlockAddsBlockEntry
...
| TC-FR-57
| UpdateBlockStatusBlockAlreadyBlockedThrowsException
| blockerUsername = "A" (id=1), blockedUsername = "B" (id=2), bloquear = true
...
| TC-FR-58
| UpdateBlockStatusUnblockRemovesEntry
...
| TC-FR-59
| UpdateBlockStatusUnblockMissingThrowsException
| blockerUsername = "A" (id=1), blockedUsername = "B" (id=2), bloquear = false
...
| TC-FR-60
| DeleteFriendValidFriendshipRemovesFriendAndReturnsTrue
...
| TC-FR-61
| DeleteFriendNoFriendshipThrowsFriendsLoadError
| usernames "A" (id=1) y "B" (id=2)
...
| TC-FR-62
| DeleteFriendUserDoesNotExistThrowsException
...
| TC-FR-63
| DeleteFriendFriendshipReverseOrderRemovesCorrectEntry
| usernames "A" (id=1) y "B" (id=2)
...
| TC-FR-64
| DeleteFriendSaveChangesIsCalled
| usernames "A" (id=1) y "B" (id=2)
| amistades contiene una amistad (1,2). +
...
| TC-FR-65
| GetFriendPublicProfileValidUserWithProfileReturnsCorrectData
| username = "seth" (id=1)
...
| TC-FR-66
| GetFriendPublicProfileUserWithoutProfileUsesDefaultValues
| username = "user" (id=1)
...
| TC-FR-67
| GetFriendPublicProfileUserNotFoundThrowsException
...
| TC-FR-68
| GetFriendPublicProfileNoMatchesShouldReturnZeroStats
...
| TC-FR-69
| GetFriendPublicProfileNullAvatarUsesDefaultAvatar
| username = "pic" (id=1)
...
| TC-FR-70
| DeleteFriendAndBlockAlreadyBlockedThrowsException
| usernames "A" (id=1) y "B" (id=2)
| usuarios contiene 1 y 2. +
...
| TC-FR-71
| DeleteFriendAndBlockSameUserThrowsException
...
| TC-FR-72
| DeleteFriendAndBlockUserNotFoundThrowsException
| usernames "A" (id=1) y "B" (id=2)
...
| TC-RR-01
| GetTop10PlayersNoPlayersReturnsEmptyList
...
| TC-RR-02
| GetTop10PlayersOnePlayerReturnsCorrectStats
...
| TC-RR-03
| GetTop10PlayersOrdersCorrectlyByWinsThenMatches
| Tres jugadores: +
...
| TC-LM-01
| ValidateCreateRequestNullRequestThrowsException
| request = null
...
| TC-LM-02
| ValidateCreateRequestInvalidMaxPlayersThrowsException
...
| TC-LM-03
| ValidateJoinRequestNullRequestThrowsException
| request = null
| Ninguna configuración especial.
...
| TC-LM-04
| ValidateJoinRequestEmptyUsernameThrowsException
...
| TC-LM-05
| IsGuestValidGuestUsernameReturnsTrue
| username = "Guest-1234"
| Ninguna configuración especial.
...
| TC-LM-06
| IsGuestInvalidGuestFormatReturnsFalse
| username = "Guest-12A4"
| Ninguna configuración especial.
| Se invoca IsGuest.
...
| TC-LM-07
| LobbyStateAddAndRemoveMemberUpdatesCountCorrectly
| username = "Seth"
...
| TC-LM-08
| LobbyStateAssignNewHostAssignsOldestMember
| Usuarios = "Ana", "Luis"
...
| TC-LM-09
| LobbyStateThrowIfFullWhenMaxPlayersReachedThrowsException
| MaxPlayers = 1
...
| TC-LM-10
| LobbyStateThrowIfGameStartedThrowsException
| N/A
...
| TC-RS-01
| ApplyBanPermanentBanAddsSanctionCorrectly
...
| TC-RS-02
| ApplyBanTemporaryBanAssignsCorrectEndDate
...
| TC-RS-03
| ApplyBanSaveChangesFailsThrowsException
...
| TC-RS-04
| HasActiveBanNoSanctionsReturnsFalse
| userId=5
| Sanciones vacío
| resultado=False
...
| TC-RS-05
| HasActiveBanUserHasInactiveSanctionReturnsFalse
| userId=5
...
| TC-RS-06
| HasActiveBanUserHasExpiredSanctionReturnsFalse
| userId=7
...
| TC-RS-07
| HasActiveBanUserHasPermanentActiveBanReturnsTrue
| userId=3
...
| TC-RS-08
| HasActiveBanTemporaryBanNotExpiredReturnsTrue
| userId=8
...
| TC-RR-01
| AddReportCreatesReportCorrectly
...
| TC-RR-02
| AddReportSaveFailsThrowsWrappedException
...
| TC-RR-03
| CountReportsForUserNoReportsReturnsZero
| reportedId=5
...
| TC-RR-04
| CountReportsForUserMultipleReportsReturnsCorrectCount
| reportedId=7
...
| TC-ELM-01
| FromCultureCodeNullReturnsEnglish
| cultureCode = null
| Ninguna configuración especial.
...
| TC-ELM-02
| FromCultureCodeEmptyReturnsEnglish
| cultureCode = ""
| Ninguna configuración especial.
...
| TC-ELM-03
| FromCultureCodeSpanishReturnsSpanish
| cultureCode = "es-MX"
| Ninguna configuración especial.
...
| TC-ELM-04
| FromCultureCodePortugueseReturnsPortuguese
| cultureCode = "pt-BR"
| Ninguna configuración especial.
...
| TC-ELM-05
| FromCultureCodeFrenchReturnsFrench
| cultureCode = "fr-FR"
| Ninguna configuración especial.
...
| TC-ELM-06
| FromCultureCodeUnknownReturnsEnglish
| cultureCode = "de-DE"
| Ninguna configuración especial.
...
| TC-V-01
| ValidateNameEmptyThrowsException
| name = ""
...
| TC-V-02
| ValidateNameTooShortThrowsException
| name = "A"
...
| TC-V-03
| ValidateNameInvalidCharactersThrowsException
| name = "Mar!o"
...
| TC-V-05
| ValidateUsernameEmptyThrowsException
| username = ""
...
| TC-V-06
| ValidateUsernameTooShortThrowsException
| username = "a"
...
| TC-V-07
| ValidateUsernameInvalidCharactersThrowsException
| username = "seth!!"
...
| TC-V-08
| ValidateUsernameValidDoesNotThrow
| username = "sethMR"
...
| TC-V-09
| ValidatePasswordEmptyThrowsException
| password = ""
...
| TC-V-10
| ValidatePasswordNoUppercaseThrowsException
| password = "hola123!"
...
| TC-V-11
| ValidatePasswordNoLowercaseThrowsException
| password = "HOLA123!"
...
| TC-V-12
| ValidatePasswordNoDigitThrowsException
| password = "HolaMundo!"
...
| TC-V-13
| ValidatePasswordNoSpecialThrowsException
| password = "Hola1234"
...
| TC-V-14
| ValidatePasswordValidDoesNotThrow
| password = "Hola123!"
...
| TC-V-15
| ValidateEmailEmptyThrowsException
| email = ""
...
| TC-V-16
| ValidateEmailTooLongThrowsException
...
| TC-V-17
| ValidateEmailInvalidFormatThrowsException
| email = "seth@@@com"
...
| TC-V-18
| ValidateEmailValidDoesNotThrow
...
| TC-V-19
| ValidateUserDtoNullThrowsException
| dto = null
...
| TC-V-20
| ValidateUserDtoInvalidNameThrowsException
...
| TC-V-21
| ValidateUserDtoValidDoesNotThrow
...
| TC-V-22
| ValidateLoginRequestNullThrowsException
| request = null
...
| TC-V-23
| ValidateLoginRequestEmptyUsernameThrowsException
...
| TC-V-24
| ValidateLoginRequestBadEmailThrowsException
...
| TC-V-25
| ValidateLoginRequestValidDoesNotThrow
...
| TC-DBOC-01
| TripFirstCallExecutesAllActions
...
| TC-DBOC-02
| TripCalledTwiceOnlyExecutesOnce
| ex = new Exception("DB down")
...
| TC-DBOC-03
| TripWhenTelegramThrowsDoesNotThrow
| ex = new Exception("DB down")
| Ninguna configuración especial; 
| Se invoca Trip. +
...
| TC-DDBOCB-04
| TripWhenDisconnectSessionsThrowsDoesNotThrow
| ex = new Exception("DB down")
| Ninguna configuración especial; 
| Se invoca Trip. +
...
| TC-DBOC-05
| TripWhenInnerExceptionOccursLogsError
| ex = new Exception("DB down")
...
| TC-RM-01
| SaveMatchResultUserColorMapNullThrowsArgumentException
...
| TC-RM-02
| SaveMatchResultUserColorMapEmptyThrowsArgumentException
...
| TC-RM-03
| SaveMatchResultWinnerUsernameNullThrowsArgumentException
...
| TC-RM-04
| SaveMatchResultWinnerUsernameEmptyThrowsArgumentException
...
| TC-RM-05
| SaveMatchResultProfileNotFoundThrowsUserProfileNotFound
...
| TC-RM-06
| SaveMatchResultValidInputCreatesMatchAndParticipants
...
| TC-RM-07
| SaveMatchResultWinnerAssignedPositionOne
...
| TC-RM-08
| SaveMatchResultFirstSaveChangesFailsThrowsDatabaseUnavailable
...
| TC-RM-09
| SaveMatchResultSecondSaveChangesFailsThrowsDatabaseUnavailable
| userColorMap válido, winnerUsername válido
| Ninguna configuración especial; 
...
| TC-RM-10
| SaveMatchResultSaveChangesValidationFailsThrowsUnknownError
| userColorMap válido, winnerUsername válido
| Ninguna configuración especial; 
| Se ejecuta SaveMatchResult. +
